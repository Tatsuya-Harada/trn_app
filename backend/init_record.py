...
with app.app_context():
    ...
    #     Exercise(user_id=user1.id, name='ランジ', memo=''),
    #     Exercise(user_id=user1.id, name='バービー', memo=''),
    #     Exercise(user_id=user1.id, name='ワイドスタンスサイドジャンプ', memo=''),
    ...
    #     Exercise(user_id=user1.id, name='フロアプッシュアップ', memo=''),
    ...
    #     Exercise(user_id=user1.id, name='シーテッドロウ', memo=''),
    #     Exercise(user_id=user1.id, name='ケーブルツイスト', memo=''),
    #     Exercise(user_id=user1.id, name='ダンベルデッドリフト', memo=''),
    #     Exercise(user_id=user1.id, name='ワンレッグデッドリフト', memo=''),
    #     Exercise(user_id=user1.id, name='バックサイドランジ', memo=''),
    #     Exercise(user_id=user1.id, name='デッドリフト', memo=''),
    #     Exercise(user_id=user1.id, name='ダンベルルーマニアアンデッドリフト', memo=''),
    #     Exercise(user_id=user1.id, name='ダンベルベンチプレス', memo=''),
    #     Exercise(user_id=user1.id, name='スケーティングトルソツイスト', memo=''),
    #     Exercise(user_id=user1.id, name='片足スクワット', memo=''),
    # ]
